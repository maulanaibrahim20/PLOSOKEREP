...
<head>
  ...
  <style>
    /* Tambahkan CSS untuk mengatur sidebar agar selalu berada di kiri */
    #kiri {
      top: 20%;
      left: 0;
      height: 100%;
    ...
    #kanan {
      margin-left: 45%; /* Sesuaikan nilai ini dengan lebar sidebar Anda */
      padding: 100px;
    }
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item" style="margin-right: 20px;">
            <a class="nav-link" href="#"><i class="bi bi-newspaper text-black"></i> Berita</a>
          </li>
          <li class="nav-item" style="margin-right: 20px;">
  ...
  <div class="container-fluid mt-4">
    <div class="row">
      <div class="col-3 sidebar" id="kiri">
        ...
        <div class="row">
          ...
          <div class="col-4 d-flex justify-content-center mb-2">
            <button class="btn btn-primary" style="height: 100px; width: 100%;">
              <img src="{{URL ('/gambar/icon/desa.png')}}" alt="" style="width: 30px; height: 30px" />
          ...
          <div class="col-4 d-flex justify-content-center mb-2">
            <button class="btn btn-primary" style="height: 100px; width: 100%;">
              <img src="{{URL ('/gambar/icon/pesan.png')}}" alt="" style="width: 30px; height: 30px" />
