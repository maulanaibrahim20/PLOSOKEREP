    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="col-8">
                ...
                <img src="{{ asset('storage/gambar/berita/' . $berita->img) }}" style="width: 700px"
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item bg-light">
                        <ul class="list-unstyled">
                            <li><a href="/umkm_d" class="text-success d-block"><i class="bi bi-caret-right-fill"></i>
                                    UMKM</a></li>
                            <li><a href="/berita" class="text-success d-block"><i class="bi bi-caret-right-fill"></i>
                                    Berita</a></li>
                        </ul>
                    </li>
