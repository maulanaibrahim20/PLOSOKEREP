    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Inventory </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            ...
                            <form id="inventoryEditForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputJabatan" name="category"
                                            placeholder="Category" value="{{ $inventory->category }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="inputJabatan" name="stock"
                                            placeholder="Stok" value="{{ $inventory->stock }}">
...
@push('js')
    <script>
        $(document).ready(function() {
            $('#inventoryEditForm').submit(function(e) {
                e.preventDefault();

                let formData = new FormData(this);

                $.ajax({
                    url: '{{ route('admin.inventory.update', $inventory->uuid) }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
